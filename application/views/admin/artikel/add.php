		...
		<div class='col-md-8'>
			<div class='box box-info'>
				...
				<div class='box-body pad'>
					...
					<? if($this->session->flashdata('validation') != null || $this->session->flashdata('add_fail') != null) : ?>
						<div class="alert alert-danger alert-dismissable">
							<i class="fa fa-ban"></i>
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?= $this->session->flashdata('validation') || $this->session->flashdata('add_fail') ?>
						</div>
					<? endif ?>
					
					<!-- Jika data berhasil ditambahkan -->
					<? if($this->session->flashdata('add_success') != null) : ?>
					...
					<div class="form-group">
						...
						<input type="text" name="jd" class="form-control" id="nama" placeholder="Masukan Judul">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea title="Ini Adalah SEO Deskrpisi Untuk Meningkatkan Hasil Pencairan Pada Search Engine. Jika Tidak Membutuhkannya Maka Tinggalkan Kosong Maka Kami Akan Menset Paragraf Pertama Dalam Artikel Anda Sebagai SEO Deskripsinya" class="form-control" rows="3" placeholder="Masukan Deskrpsi SEO."></textarea>
					</div>
					<div class="form-group">
						<label for="nama">Tags</label>
						<input type="text" name="jd" class="form-control" id="nama" placeholder="Masukan Tags Artikel Pisahkan Dengan Koma">
					</div>
		...
		<div class='box box-info'>
			<div class='box-body pad'>
				...
				<label class="badge bg-blue">
					<input type="checkbox" value="<?= $row->kategori_id ?>">
