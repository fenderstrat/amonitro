...
$upload_dir = '/new-anpanel/images-upload-filemanager/'; // path from base_url to upload base dir
$current_path = '../../../../../images-upload-filemanager/'; // relative path from filemanager folder to upload files folder
